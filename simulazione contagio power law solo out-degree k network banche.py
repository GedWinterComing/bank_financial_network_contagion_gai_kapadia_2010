...
#    plt.bar(valoridelvettore, conteggi)
    fig.tight_layout()
#%%
prova=generatore_matrice_adiacenza_con_z_voluto_da_power_law_out_preferential_attachment(1000,10)
...
results = powerlaw.Fit(kappa_degree_sequence)
...
# Infine, per quella esatta, 1000 simulazioni con 1000 banche servono ben 8 ore e 5 minuti !!!
...
plt.grid()
plt.xlim(-0.2,10.8)
# plt.savefig('contagio grafico 1000 banche 1000 simulazioni ogni z da 0.5 powerlaw solo out e in omogeneo.jpg', dpi=950, transparent=False, bbox_inches="tight")
