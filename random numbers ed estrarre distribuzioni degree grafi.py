...
campione = int( 1000/2 ) # quanti numeri vuoi estrarre dalla distribuzione?
...
# ax = Axes3D(fig)
# ax = fig.gca(projection='3d') # oppure anche così, non so che differenza ci sia. Ma non funziona più nel 2026, è deprecated. 
